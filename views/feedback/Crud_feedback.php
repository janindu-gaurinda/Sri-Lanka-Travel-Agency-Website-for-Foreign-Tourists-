                ...
                <table id="pkg_edit" class="table table-striped table-bordered text-center align-middle" style="width:100%">
                    ...
                    <tbody>
                        <?php if (!empty($Get_feedback)) : ?>
                            <?php foreach ($Get_feedback as $feedback) : ?>
                                <tr>
                                    <!-- Image -->
                                    ...
                                    <?php
                                    $status = strtolower(trim($feedback['statusfeedback']));
                                    if ($status == 'active') {
                                        $color = 'success';
                                    ...
                                    <td class="d-flex justify-content-center align-items-center gap-2">
                                        ...
                                        <form action="index.php?controller=feedback&action=delete_feedback" method="post" onsubmit="return confirm('Are you sure you want to delete this Package?')" style="margin: 0;">
                                            ...
                                            <input type="hidden" name="link" value="curd_feedback">
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-center">
                                                <form class="row g-3" action="index.php?controller=feedback&action=update_feedback_admin" method="post" id="myupdateForm" enctype="multipart/form-data">
                                                    <!-- <==================================================================--  -->

                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text" id="basic-addon1">Country</span>
                                                        <select class="form-select" id="curd_country" name="country" required>
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <select class="form-select" name="status" aria-label="Default select example" required>
                                                            <option value="<?php echo htmlspecialchars($feedback['statusfeedback']); ?>" selected><?php echo htmlspecialchars($feedback['statusfeedback']); ?> !! SELECTED</option>
