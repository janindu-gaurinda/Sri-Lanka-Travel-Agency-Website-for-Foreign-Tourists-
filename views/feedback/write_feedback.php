...
?>
<div class="container pt-4" data-aos="zoom-in-up" data-aos-delay="300">
    <br>
    <div class="row justify-content-center">
        <div class="col-md-8">
            <form action="index.php?controller=feedback&action=insert_feedback" id="feedback_form" method="POST" enctype="multipart/form-data" class="card p-4 shadow border-0 rounded-4 bg-light" data-parsley-validate>
                <h4 class="text-center mb-4 fw-bold text-primary">Share Your Experience ✈️</h4>

                <div class="mb-3">
                    <label for="country" class="form-label fw-semibold">
                        <i class="bi bi-geo-alt-fill me-1"></i>Country
                    </label>
                    <select class="form-select-lg rounded-pill px-3" id="country" name="country" required>
                ...
                <div class="mb-3">
                    <label for="review_text" class="form-label fw-semibold">
                        <i class="bi bi-chat-text-fill me-1"></i>Review
                    </label>
                    <textarea class="form-control form-control-md rounded-4" id="review_text" name="review_text" rows="4" placeholder="Write your feedback..."
                        maxlength="160"
                        required
                    ...
                    <div class="form-text text-end"><small>Max 200 characters</small></div>
                </div>
