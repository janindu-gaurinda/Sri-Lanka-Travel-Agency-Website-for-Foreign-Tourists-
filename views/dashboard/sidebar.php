...
<div class="col-1 bg-dark d-flex flex-column justify-content-between position-fixed start-0 top-0 vh-100 p-0">
    <div class="nav flex-column text-left mt-2">
        ...
        <div class="btn-group dropend my-2">
            ...
            <ul class="dropdown-menu dropdown-menu-dark">
                <li><a class="dropdown-item" href="index.php?controller=Home&action=index">Packages</a></li>
                <hr class="dropdown-divider">
            </ul>
        </div>
        <!-- ================================================================= -->
        <div class="btn-group dropend my-2">
            ...
            <ul class="dropdown-menu dropdown-menu-dark">
                <li><a class="dropdown-item" href="index.php?controller=Home&action=index">Destinations</a></li>
                <hr class="dropdown-divider">
            </ul>
        </div>
        <!-- ================================================================= -->
        ...
        <div class="btn-group dropend my-2">
            ...
            <ul class="dropdown-menu dropdown-menu-dark">
                <li><a class="dropdown-item" href="index.php?controller=Home&action=index">Feedback</a></li>
                <hr class="dropdown-divider">
            </ul>
        </div>
        <!-- ================================================================= -->
        ...
        <div class="btn-group dropend my-2">
            ...
            <ul class="dropdown-menu dropdown-menu-dark">
                <li><a class="dropdown-item" href="index.php?controller=Home&action=index">Travel Tips</a></li>
                <hr class="dropdown-divider">
            </ul>
        </div>
        <!-- ================================================================= -->
